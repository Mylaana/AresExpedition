...
import { ProjectEffectEventFactory } from "../../services/cards/project-card-played-effect.service";
...
export class CardCost {
	...
	updateCostMod(mod?: CostMod): number{
		...
		if(mod.playedTriggersList){newMod += ProjectEffectEventFactory.costMod.getCostMod(mod.playedTriggersList, this.projectCard)}
