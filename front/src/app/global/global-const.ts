...
import { ActionPhaseType, ConstructionPhaseType, DevelopmentPhaseType, PhaseCardGroupType, PhaseCardType, ProductionPhaseType, ResearchPhaseType } from "../types/phase-card.type"
...
export const GAME_PHASE_GROUP_LIST: PhaseCardGroupType[] = ['development', 'construction', 'action', 'production', 'research']
