...
export type PostGameDataTitle = 'lineSeparator'
| 'titleCards' | 'titlePhaseSelected' | 'titleParameterContribution' | 'titleAwardsMilestones'
| 'cardSeen' | 'cardSold' 
| 'phaseTotalDevelopment'| 'phaseTotalConstruction'| 'phaseTotalAction'| 'phaseTotalProduction'| 'phaseTotalResearch'
| 'contributionTemperature' | 'contributionOcean' | 'contributionOxygen' | 'contributionMoonStructure' | 'contributionInfrastructure'
| 'totalAwards' | 'totalMilestones'